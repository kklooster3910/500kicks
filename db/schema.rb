...
ActiveRecord::Schema.define(version: 2019_08_07_202847) do
  ...
  create_table "comments", force: :cascade do |t|
    ...
    t.index ["photograph_id"], name: "index_comments_on_photograph_id"
  end
  ...
  create_table "likes", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["photo_id", "photographer_id"], name: "index_likes_on_photo_id_and_photographer_id", unique: true
